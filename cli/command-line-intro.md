...
Tells you about the /Users  directory itself

    ls -l /Users/

Tells you what's *in* the /Users  directory
...
We already learned one command that will create a file, touch. Lets create a folder in /Users for you to work in and then another directory cli. We will use the environment variable $USER, that is your username.
...
```
msettles@tadpole:/Users/mattsettles/cli$ ./test.sh genome.fa
    1686 T
    1292 A
    1253 G
    1155 C
